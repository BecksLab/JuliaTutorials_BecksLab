...
8. The `copy` function in Julia does not behave as one intuitively expects and if you want to make changes to a copied item without altering the original use `deepcopy` instead
